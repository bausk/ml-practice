...
<!-- **УВАГА!** Використовуйте власний PDF-документ. Він має бути достатньо великим (бажано мати більше 100 сторінок) та містити достатньо тексту для генерації відповідей. Це може бути ваш підручник з дисципліни, улюблена книга і так далі. Важливо, щоб документ містив саме текст, а не був тільки добіркою сканів, фотографій.

Використовуйте PDF документ англійською мовою, оскільки нейронна мережа, яку ми будемо використовувати, навчена здебільшого на англійському корпусі даних.
...
https://archive.org/details/texts?tab=collection (нажаль, тут не всі книги мають відкритий доступ до PDF)

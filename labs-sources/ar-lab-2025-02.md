...
1. **Трансієнтне джерело (Transient Hit Test Source)** - промінь виходить з певної точки у просторі відстеження, наприклад, з центру екрану
2. **Постійне джерело (Persistent Hit Test Source)** - промінь виходить з певної точки у просторі відліку, наприклад, з контролера
...
Видаліть непідсвічений куб і замініть його сценою, що включає освітлення:
...
Додайте в <head> вашого HTML файлу GLTFLoader.
...
Щоб створити джерело тесту зіткнень, додайте цей код після створення локального простору відліку:

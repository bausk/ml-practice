...
**Що включити у звіт:**
- Обґрунтування вибору набору даних (1–2 абзаци)
- Графіки EDA: розподіл цільової змінної, кореляційна матриця
- Архітектура моделі та вибір гіперпараметрів
- Криві навчання (train/val loss)
- Фінальні метрики на тестовому наборі
- Для регресії: scatter plot (predicted vs actual), residual plot
- Для класифікації: confusion matrix, classification report
- Аналіз результатів (1–2 абзаци): що працює, що ні, чому

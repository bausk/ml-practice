...
4. Опис ходу виконання роботи:
   - Налаштування середовища розробки та встановлення залежностей;
   - Підготовка та обробка набору даних;
   - Тренування та валідація логістичної або поліноміальної регресії;
   - Реалізація моделі класифікації на основі ResNet (передавальне навчання);
   - Застосування Grad-CAM для візуалізації, аналізу рішень моделі;
   - Реалізація семантичної сегментації;
   - Побудова та тестування комбінованого конвеєру;
5. Результати роботи (в окремих кроках виконання роботи включіть відповідні цим кроками результати):
   - Криві навчання моделі;
   - Результати виконаного тренування регресійної моделі;
   - Матриця плутанини та метрики класифікації (precision, recall, F1-score);

...
**Чи достатньо поліноміальних ознак для нелінійних меж?** Так! Пригадайте трюк із розширення простору ознак з розділу про регресію. Той самий принцип працює і для класифікації. Якщо у нас є дві ознаки $x_1$ та $x_2$, ми можемо створити нові поліноміальні ознаки:
...
4. **Обов'язково використовуйте регуляризацію** (L2, dropout) при високих степенях

...
Module 2: Computer Vision for Games (Lectures 4-8)
...
Lecture 5 — Jupyter Notebook Workshop
Hands-on workshop with Jupyter Notebooks. Setting up the environment, navigating the interface, running cells, using magic commands. Practical exercises covering Python basics, data exploration, visualization, and markdown documentation within notebooks. Best practices for reproducible research notebooks.
...
Lecture 9 — Sequence Processing: RNNs, LSTMs, and Attention
...
Lecture 11 — Large Language Models: From Pre-training to Reasoning
...
Module 4: Reinforcement Learning for Games (Lectures 12-14)
Lecture 12 — Reinforcement Learning Fundamentals
...
Lecture 14 — Game AI: Self-Play, Multi-Agent Systems, and Practical Tools
...
Module 5: Generative AI and Modern Applications (Lectures 15-17)
Lecture 15 — Generative Models: GANs, VAEs, and Diffusion
...
Lecture 16 — Fine-tuning, RAG, and Domain Adaptation
...
Lecture 17 — AI Agents: Architecture, Tools, and Orchestration
...
Module 6: Production and Applied Game AI (Lectures 18-20)
Lecture 18 — Machine Learning in Production (MLOps)
...
Lecture 19 — AI Techniques in Modern Video Game Development
...
Lecture 20 — Emerging Trends, Ethics, and Continuous Learning in AI
